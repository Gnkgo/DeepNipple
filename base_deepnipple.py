...
parser.add_argument('--img_folder', type=str, default = '/home/cluster/jbrodbec/DeepNipple/sexy', help='path to the folder containing input images')
...
parser.add_argument('--save_path', type=str, default='segmentation_output', help='path to save the output')
